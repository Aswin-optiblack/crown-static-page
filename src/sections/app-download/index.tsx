    ...
    <div className="md:mt-20 mt-12 mb-5 border-4 border-[#F8A80D] rounded-2xl md:p-10 p-6 bg-[#E8E0EF] w-full relative">
      ...
      >
        ...
        <div className="md:p-6 p-3 relative flex flex-col items-center justify-center mt-1">
          ...
          <div className="absolute -top-[15%] sm:-top-[20%] md:-top-[20%] -right-[1%] sm:-right-[2%] md:-right-[2%]">
            <Image
          ...
          <div className="absolute -bottom-[5%] sm:-bottom-[9%] md:-bottom-[9%] right-0">
            <Image 
              src="/assets/lock.svg" 
              className="md:w-[140px] md:h-[140px] sm:w-[110px] sm:h-[110px] w-[80px] h-[80px]" 
      ...
      <div className="absolute bottom-1/2 left-1/4 sm:left-1/3 z-10">
        <Image
          src="/assets/white_star.svg"
          className="md:w-[20px] md:h-[20px] sm:w-[18px] sm:h-[18px] w-[15px] h-[15px]"
          height={20}
